...
corrplot(cor(dados_estrelas[,c(1,2,3,4)]), order= c("FPC"), tl.offset = 1, number.cex = 1.5,
         cl.pos = 'b',cl.cex = 1,tl.cex = 1, method = "number", tl.col="black",
         addgrid.col="grey", col = colorRampPalette(c("red", "gray", "blue"))(30))
```
