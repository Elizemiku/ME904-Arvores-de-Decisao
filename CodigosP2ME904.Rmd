...
bag_teste_estrelas <- predict(mod_bag_estrelas, newdata = estrelas_teste, type = "prob")

import_var_estrelas <- plot(varImp(mod_bag_estrelas), xlab = "Importância")

caret::confusionMatrix(mod_bag_estrelas, reference = estrelas_teste$tipo)
```
...
boostM_teste_estrelas <- predict(mod_boostM_estrelas, newdata = estrelas_teste, type = "prob")

import_var_estrelas_bost <- plot(varImp(mod_boostM_estrelas), xlab = "Importância")

caret::confusionMatrix(mod_boostM_estrelas, reference = estrelas_teste$tipo)
