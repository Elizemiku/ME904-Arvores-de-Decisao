...
(temp_stars <- ggplot(dados_estrelas) +
  geom_boxplot(aes(x = cor, y = temperatura, fill = cor)) + 
...
```{r}
# salvando graficos que vao pro relatorio
ggsave("temp_lumi.jpg", c_bmi, width = 16.5, height = 8, units = "cm")
ggsave("raio_magnitude.jpg", c_regiao_box, width = 16.5, height = 8, units = "cm")
```
